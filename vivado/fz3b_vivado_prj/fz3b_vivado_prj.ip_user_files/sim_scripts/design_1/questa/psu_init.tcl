...
set psu_mio_init_data {
    ...
    mask_write 0XFF180204 0x7BFFEF7F 0x52000600
    ...
    mask_write 0XFF180208 0xFFFFEE6F 0x00B02000
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x023FF69E
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x01FFF9FF
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01FFF7F5
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD480020 0x0000FFFF 0x0000C000
